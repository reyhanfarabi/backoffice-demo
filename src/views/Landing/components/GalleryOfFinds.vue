    ...
    <div class="gallery-of-finds">
        ...
        <div class="gallery-of-finds__wrapper">
            <div class="gallery-of-finds__column-wrapper">
                <img v-for="(image, index) in images.left" :key="index" class="gallery-of-finds__image-box" :src="image"
                    alt="Gallery Photo" />
            </div>
            <div class="gallery-of-finds__column-wrapper">
                <img v-for="(image, index) in images.center" :key="index" class="gallery-of-finds__image-box"
                    :src="image" alt="Gallery Photo" />
            </div>
            <div class="gallery-of-finds__column-wrapper">
                <img v-for="(image, index) in images.right" :key="index" class="gallery-of-finds__image-box"
                    :src="image" alt="Gallery Photo" />
            </div>
        </div>
    </div>
