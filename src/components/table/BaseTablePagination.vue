<template>
  <div
    class="flex justify-end items-center sticky bottom-0 bg-neutral-200 dark:bg-neutral-700 rounded px-3 py-2"
  >
    <div class="flex items-center gap-8">
      ...
      <BaseButton type="outlined" @click="$emit('changePageEvent')">
